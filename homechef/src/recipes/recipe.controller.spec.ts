...
describe('RecipeControllers', () => {
    ...
    const createRecipeDtoStub = CreateRecipeDtoStub();
    ...
    beforeEach(async () => {
        ...
        recipeViewController = app.get<RecipesViewController>(RecipesViewController);
  ...
  describe('RecipeApiController', () => {
    ...
    describe('updateRecipe', () => {
        it('should return the updated recipe', async () => {
            ...
            expect(recipeService.updateRecipe).toHaveBeenCalledWith(recipeId, recipe);
